...
declare namespace bleat {
  ...
  export interface FoundFunc {
    (device: Device): void
  }
  export function startScan(
    serviceUUIDs: string | FoundFunc,
    foundFn?: FoundFunc,
    errorFn?: ErrorFunc
  )
  ...
  export interface Device {
    ...
    disconnect()
    connect(
      connectFn: EmptyCallback,
      disconnectFn: EmptyCallback,
  ...
  export interface Characteristic {
    ...
    enableNotify(
      notifyFn: (data: DataView) => void,
      completeFn?: EmptyCallback,
      errorFn?: ErrorFunc
    )
