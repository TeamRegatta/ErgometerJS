...
declare namespace webbluetooth {
  ...
  export type CharacteristicsValueChangedEventHandler = (
    ev: CharacteristicsValueChangedEvent
  ) => any
...
declare namespace BluetoothUUID {
  export function getService(
    name: webbluetooth.DOMString | webbluetooth.UnsignedLong
  ): webbluetooth.UUID
  ...
  export function canonicalUUID(
    alias: webbluetooth.UnsignedLong
  ): webbluetooth.UUID
}
interface Navigator {
