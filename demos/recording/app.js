    ...
    (function (ble) {
        var ReplayDriver = /** @class */ (function () {
            ...
            ReplayDriver.prototype.isSameEvent = function (event1, event2) {
                ...
                if (result &&
                    ergometer.utils.isDefined(event1.data) &&
                    ergometer.utils.isDefined(event2.data) &&
                    event1.data &&
                    event2.data) {
                    var data1 = event1.data;
                    var data2 = event2.data;
                    if (result &&
                        (ergometer.utils.isDefined(data1.serviceUIID) ||
                            ergometer.utils.isDefined(data2.serviceUIID))) {
                        result = data1.serviceUIID === data2.serviceUIID;
                    }
                    if (result &&
                        (ergometer.utils.isDefined(data1.characteristicUUID) ||
                            ergometer.utils.isDefined(data2.characteristicUUID))) {
            ...
            ReplayDriver.prototype.checkQueue = function () {
                ...
                var _loop_1 = function () {
                    ...
                    if (this_1.isCallBack(ble.RecordingEventType[event_1.eventType])) {
...
(function (ergometer) {
    ...
    (function (csafe) {
        ...
        csafe.registerStandardSet('setProgram', 36 /* SETPROGRAM_CMD */, function (params) {
            return [ergometer.utils.getByte(params.value, 0), 0];
        });
        csafe.registerStandardSet('setTime', 17 /* SETTIME_CMD */, function (params) {
            return [params.hour, params.minute, params.second];
        });
        csafe.registerStandardSet('setDate', 18 /* SETDATE_CMD */, function (params) {
            return [ergometer.utils.getByte(params.year, 0), params.month, params.day];
        });
        csafe.registerStandardSet('setTimeout', 19 /* SETTIMEOUT_CMD */, function (params) {
            return [params.value];
        });
        csafe.registerStandardSet('setWork', 32 /* SETTWORK_CMD */, function (params) {
            return [params.hour, params.minute, params.second];
        });
        csafe.registerStandardSet('setDistance', 33 /* SETHORIZONTAL_CMD */, function (params) {
            return [
                ergometer.utils.getByte(params.value, 0),
                ergometer.utils.getByte(params.value, 1),
                params.unit
            ];
        });
        csafe.registerStandardSet('setTotalCalories', 35 /* SETCALORIES_CMD */, function (params) {
            return [ergometer.utils.getByte(params.value, 0), ergometer.utils.getByte(params.value, 1)];
        });
        csafe.registerStandardSet('setPower', 52 /* SETPOWER_CMD */, function (params) {
            return [
                ergometer.utils.getByte(params.value, 0),
                ergometer.utils.getByte(params.value, 1),
                params.unit
...
(function (ergometer) {
    ...
    (function (csafe) {
        ...
        csafe.registerStandardShortGet('getDistance', 161 /* GETHORIZONTAL_CMD */, function (data) {
...
(function (ergometer) {
    ...
    (function (csafe) {
        // ----------------------------- workout type ------------------------------------
        csafe.registerStandardSetConfig('setWorkoutType', 1 /* PM_SET_WORKOUTTYPE */, function (params) {
            return [params.value];
        });
    })(csafe = ergometer.csafe || (ergometer.csafe = {}));
})(ergometer || (ergometer = {}));
...
(function (ergometer) {
    ...
    var PerformanceMonitor = /** @class */ (function () {
        ...
        PerformanceMonitor.prototype.handleCSafeNotifications = function () {
            ...
            this.driver
                .enableNotification(ergometer.ble.PMCONTROL_SERVICE, ergometer.ble.RECEIVE_FROM_PM_CHARACTERISIC, function (data) {
                ...
                if (dataView.byteLength !== 1 || dataView.getUint8(0) !== 0) {
                    ...
                    if (dataView.byteLength !== ergometer.ble.PACKET_SIZE &&
                        frameState !== 0 /* initial */) {
                        frameState = 0 /* initial */;
        ...
        PerformanceMonitor.prototype.enableMultiplexNotification = function () {
            ...
            if (this._multiplexSubscribeCount === 0) {
                this.driver
                    .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.MULTIPLEXED_INFO_CHARACTERISIC, function (data) {
        ...
        PerformanceMonitor.prototype.disableMultiPlexNotification = function () {
            ...
            if (this._multiplexSubscribeCount === 0) {
                this.driver
                    .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.MULTIPLEXED_INFO_CHARACTERISIC)
            ...
            if (this.connectionState >= MonitorConnectionState.servicesFound) {
                if (this.rowingGeneralStatusEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.ROWING_STATUS_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.ROWING_STATUS_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.rowingAdditionalStatus1Event.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_STATUS1_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_STATUS1_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.rowingAdditionalStatus2Event.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_STATUS2_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_STATUS2_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.rowingStrokeDataEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.STROKE_DATA_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.STROKE_DATA_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.rowingAdditionalStrokeDataEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_STROKE_DATA_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_STROKE_DATA_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.rowingSplitIntervalDataEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.SPLIT_INTERVAL_DATA_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.SPLIT_INTERVAL_DATA_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.rowingAdditionalSplitIntervalDataEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_SPLIT_INTERVAL_DATA_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_SPLIT_INTERVAL_DATA_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.workoutSummaryDataEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.ROWING_SUMMARY_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.ROWING_SUMMARY_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                if (this.additionalWorkoutSummaryDataEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_ROWING_SUMMARY_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.EXTRA_ROWING_SUMMARY_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
                ...
                if (this.heartRateBeltInformationEvent.count > 0) {
                    if (this.multiplex) {
                        ...
                        this.driver
                            .enableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.HEART_RATE_BELT_INFO_CHARACTERISIC, function (data) {
                    ...
                    if (this.multiplex)
                        ...
                        this.driver
                            .disableNotification(ergometer.ble.PMROWING_SERVICE, ergometer.ble.HEART_RATE_BELT_INFO_CHARACTERISIC)
                            .catch(this.getErrorHandlerFunc(''));
                    }
                }
        ...
        PerformanceMonitor.prototype.handleRowingGeneralStatus = function (data) {
            var parsed = {
                ...
                distance: ergometer.utils.getUint24(data, 3 /* DISTANCE_LO */) /
                    10,
        ...
        PerformanceMonitor.prototype.handleRowingAdditionalStatus1 = function (data) {
            var parsed = {
                ...
                restTime: ergometer.utils.getUint24(data, 13 /* REST_TIME_LO */) *
                    10,
                averagePower: null
            };
            if (data.byteLength ===
        ...
        PerformanceMonitor.prototype.handleRowingStrokeData = function (data) {
            ...
            if (data.byteLength === 20 /* BLE_PAYLOAD_SIZE */) {
                ...
                parsed = {
                    ...
                    driveLength: data.getUint8(6 /* DRIVE_LENGTH */) /
                        100,
                    driveTime: data.getUint8(7 /* DRIVE_TIME */) * 10,
                    strokeRecoveryTime: data.getUint16(8 /* STROKE_RECOVERY_TIME_LO */) * 10,
        ...
        PerformanceMonitor.prototype.sendCsafeCommands = function (byteArray) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (byteArray && byteArray.length > 0) {
                    ...
                    var bytesToSend_1 = [ergometer.csafe.defs.FRAME_START_BYTE]
                        .concat(byteArray)
                    ...
                    while (sendBytesIndex_1 < bytesToSend_1.length) {
                        ...
                        var bufferLength = Math.min(ergometer.ble.PACKET_SIZE, bytesToSend_1.length - sendBytesIndex_1);
                        ...
                        _this.driver
                            .writeCharacteristic(ergometer.ble.PMCONTROL_SERVICE, ergometer.ble.TRANSMIT_TO_PM_CHARACTERISIC, dataView)
                            .then(function () {
